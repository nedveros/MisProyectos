...
void igvCamara::aplicar(void) {
	...
	//Rotamos la cámara en el ángulo deseado
	glRotatef(grado, 0, 1, 0);
}

/*Función que hace zoom en la cámara
*/
...
/*Función que aumenta hacia la derecha la rotación de la cámara
*/
void igvCamara::girarDerecha() {
	grado = grado + 10;
}

/*Función que aumenta hacia la izquierda la rotación de la cámara
*/
